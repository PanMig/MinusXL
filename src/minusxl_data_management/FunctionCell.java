...
public class FunctionCell extends Cell<Object>{
	...
	FunctionCell(int row, int column, Cell[] input_cells, String function) {
		...
		switch(function){
		// Here, depending on the requested function, we create the corresponding one...
		
			// 1: Mathematical Functions:
			case "Abs": this.function = new AbsFunction(input_cells);
			break;
			
			case "Cos": this.function = new CosFunction(input_cells);
			break;
				
			case "Mult": this.function = new MultFunction(input_cells);
			break;
			
			case "Pow": this.function = new PowFunction(input_cells);
			break;
			
			case "Log": this.function = new LogFunction(input_cells);
			break;
			
			case "Sum": this.function = new SumFunction(input_cells);
			break;
				
			case "Log10": this.function = new Log10Function(input_cells);
			break;
			...
			default: 
				// TODO: Right now, using the console - later maybe using the GUI, return an error message
